...
2. 结合先行词的结构特点和位置特点，在关系词之前寻找与定语从句的意思有逻辑语义联系的名词、短语或从句，这即为先行词
...
3. 看从句的名词: 所用介词须与定语从句中的名词构成固定搭配（少见）
