...
- [ ] [15 从句与非谓语](#15-从句与非谓语)
- [ ] [16 虚拟语气](#16-虚拟语气)
- [ ] [17 时态 - 一般时态](#17-时态---一般时态)
- [ ] [18 时态 - 进行时态](#18-时态---进行时态)
- [ ] [19 时态 - 完成时态](#19-时态---完成时态)
- [ ] [20 时态 - 完成进行时态](#20-时态---完成进行时态)
...
### 7.9.2 否定句 - 拒绝许可，甚至禁止
### 7.9.3 could一般不用来表示现在的许可，而表示过去的许可
...
### 7.10.1 could表示'建议'
### 7.10.2 Shall I, Shall we
### 7.10.3 may/might (just) as well
...
### 7.10.4 should和ought to表示'忠告'
### 7.10.5 should表示'忠告'与could表示'建议'的比较
...
### 7.10.6 had better表示'忠告'

had better在表示"忠告"时，有时会暗含"如果不这么做，就会有不良后果"的意思，而should则更为中性

## 7.11 基本用法(六): 意愿willingness, 意图intention与执意insistence
...
## 7.15 基本用法(十): shall的特殊用法
### 7.15.1 用于第一人称的疑问句中: Shall I/we
...
## 7.17 情态动词的否定
### 7.17.1 情态动词否定意义的深层结构 - 内部否定和外部否定
...
### 7.17.2 内部否定和外部否定的使用规律

1. 推测用法的情态动词，一般是内部否定，即否定的是谓语动作
2. 基本用法的情态动词，一般是外部否定，即否定的是情态意义

## 7.18 总结: 英文情态与中文情态的简单对比
### 7.18.1 英文情态意义与中文情态意义的对应性
### 7.18.2 英文情态动词的委婉表达在汉语中的缺失
...
### 9.2.1 that引导的主语从句
### 9.2.2 whether及连接代词或连接副词引导的主语从句
### 9.2.3 because引导的主语从句
...
### 10.12.1 使用关系词what的前提: what的前面不能有先行词
...
### 10.13.1 用when引导定语从句，其先行词必须是表示时间的名词
...
### 10.13.2 先行词表示时间时，不一定都用when引导定语从句
...
### 10.13.3 如何区分when引导的定语从句与when引导的时间状语从句
...
## 10.14 关系副词 where
### 10.14.1 用where引导定语从句，其先行词通常是表示地点的名词
...
状语从句的种类 | 常用连接词 | 特殊连接词
--- | --- | :-:
时间状语从句 | when, while, as, before, after, since, till, until, as soon as | 1. 一些表示时间的名词: the moment, the instant, the minute, the day, next time, every time 2. 一些副词: instantly, immediately, directly 3. 固定搭配的连词: no sooner.. than, hardly..when, scarcely..when
地点状语从句 | where | wherever, anywhere, everywhere
原因状语从句 | because, as, for, since | seeing that, considering that, now that, given that, in that, in as much as, in so much as
目的状语从句 | so that, in order that, that | lest, for fear that, in case, in the hope that, on/for purpose that, to the end that
...
条件状语从句 | if, unless | suppose/supposing, providing/provided, on condition that, so/as long as
让步状语从句 | although, though, even though, even if |1.while(一般用在句首) ，as(用于倒装结构)  2. whatever, whoever, whichever, however, whenever, wherever, whether...or 3. "as+形容词+as+主谓"结构用在句首
比较状语从句 | as, than | the more.., the more; just as.., so..; A is to B what/as C is to D; no more...than; not A so much as B/not so much A as B
方式状语从句 | as, the way |
...
so that, in order that或that。另外，在目的状语从句中常含有情态动词，比如may/might或can/could
...
### 11.8.2 only if与if only

only if表示"只有"，而if only表示"只要"

### 11.8.3 must/have to do...if...be to do
...
表示让步逻辑关系的介词后面可以接名词、名词短语、动名词或what从句；表示让步关系的连词后面可以接完整的陈述句、形容词（相当于省略句）、分词（相当于省略句）等

Though tired, he would't stop working.
* Though he was tired, he wouldn't stop working.

### 11.9.3 置于句首的while一般表示"尽管"
### 11.9.4 no matter wh-
...
### 11.10.9 A is to B what/as C is to D
...
# 12 不定式
## 12.1 非谓语动词概述
## 12.2 不定式的作用(一): 作主语(It+to do)
### 12.2.1 不定式放在句首作主语
### 12.2.2 不定式放在句末作主语
## 12.3 不定式的作用(二): 作宾语(动词+to do)
### 12.3.1 结构一: 动词+to do
### 12.3.2 结构二: 动词+疑问词+to do
### 12.3.3 结构三: 动词+it+宾语补足语+to do
## 12.4 不定式的作用(三): 作宾语补足语(动词+宾语+to do)
## 12.5 不定式的作用(四): 作定语(名词+to do)
### 12.5.1 宾语关系
### 12.5.2 主语关系
### 12.5.3 同位语关系
### 12.5.4 状语关系
### 12.5.5 补语关系
## 12.6 不定式的作用(五): 形容词+to do
### 12.6.1 宾语关系(一): He is interesting to listen to.
### 12.6.2 宾语关系(二): The book is interesting to buy.
### 12.6.3 主语关系(一): He is kind to help us.
### 12.6.4 主语关系(二): He is glad to help us.
### 12.6.5 主语关系(三): He is slow to react.
## 12.7 不定式的作用(六): 作状语
### 12.7.1 目的状语
### 12.7.2 结果状语
### 12.7.3 条件状语
### 12.7.4 原因状语
## 12.8 不定式的作用(七): 独立使用的不定式
### 12.8.1 不定式作独立成分
### 12.8.2 不定式引导独立的句子
## 12.9 不定式的逻辑主语
### 12.9.1 何谓逻辑主语
### 12.9.2 不定式逻辑主语的构成(一): for+名词或代词+to do
### 12.9.3 不定式逻辑主语的构成(二): of sb. to do
## 12.10 不定式的时态和语态(一): 被动式(to be done)
### 12.10.1 不定式时态/语态简介
### 12.10.2 被动不定式
### 12.10.3 双重被动式
## 12.11 不定式的时态和语态(二): 完成式(to have done)
### 12.11.1 表示在谓语动作之前发生的动作
### 12.11.2 表示"非真实的"过去
### 12.11.3 偶尔表示将来的动作
## 12.12 不定式的时态和语态(三): 进行式(to be doing)
## 12.13 不定式的时态和语态(四): 完成进行式(to have been doing)
## 12.14 省去to的不定式
### 12.14.1 在某些动词的复合宾语中
### 12.14.2 在特定的句型结构中
# 13 动名词
...
### 13.5.2 所有格还是普通格?
### 13.5.3 动名词复合结构的用法
## 13.6 动名词的时态和语态(一): 被动式(being done)
### 13.6.1 动名词的时态和语态概述
### 13.6.2 动名词的被动式
### 13.6.3 主动形式表示被动意思
## 13.7 动名词的时态和语态(二): 完成式(having done)
### 13.7.1 动名词的完成主动式
### 13.7.2 动名词的完成被动式
## 13.8 there be的不定式与动名词形式
### 13.8.1 there be的动名词形式
### 13.8.2 there be的不定式形式
# 14 分词
## 14.1 分词的意义
### 14.1.1 引言: 一个真实的故事
### 14.1.2 现在分词的意义
### 14.1.3 过去分词的意义
## 14.2 分词的作用(一): 状语
### 14.2.1 主语一致: 单独的分词(短语)作状语
### 14.2.2 独立分词结构(一): "名词+分词"作状语
### 14.2.3 独立分词结构(二): "with+名词+分词"作状语
### 14.2.4 固定结构
### 14.2.5 分词作状语的意义
## 14.3 分词的作用(二): 定语
### 14.3.1 单个分词作定语要前置
...
### 14.3.3 后置定语的三种被动结构
## 14.4 分词的作用(三): 补足语
### 14.4.1 分词在感觉动词后充当宾语补足语
### 14.4.2 作补足语的分词与不定式的区别
## 14.5 分词作成分要注意的问题
### 14.5.1 定语还是状语?
### 14.5.2 不能用作定语的分词结构
### 14.5.3 不能用作状语的分词结构
...
## 16.3 现在虚拟(ZxCx)
## 16.4 过去虚拟(ZgCg)
## 16.5 混合虚拟(一): 主句现在+从句过去(ZxCg)
## 16.6 混合虚拟(二): 主句过去+从句现在(ZgCx)
## 16.7 倒装虚拟
...
### 16.9.2 在it is+形容词/过去分词/特定的名词+that的主语从句中
...
### 16.9.3 在上述名词的表语从句和同位语从句中
## 16.10 各种虚拟句型
### 16.10.1 在wish 后面的宾语从句中
...
### 16.10.3 在as if/as though引导的从句中
...
### 17.2.1 用法一: 表示普遍的事实或真理(expressing a general truth)
### 17.2.2 用法二: 表示重复活动(expressing a regularly occurring event)
...
### 17.3.5 口语用法: 'I don't know' or 'I didn't know'?
...
### 17.4.1 引言
### 17.4.2 will, be going to 表示将来 - 预测
...
### 17.4.4 be going to表示计划与will表示意愿
...
### 18.1.3 进行时态的使用语境
## 18.2 现在进行时-不一定正在进行
### 18.2.1 用法(一): action happening exactly now

A: What are you doing?

B: I'm doing my laundry.

### 18.2.2 用法(二): action happening around now

A: What are you doing these days?

B: I'm taking Prof.Zhang's grammer course in New Oriental School.

### 18.2.3 用法(三): 用于表示'改变'的动词，强调'逐渐变化'的过程
...
### 18.2.4 用法(四): 用于强烈的感情色彩的表达
### 18.2.5 用法(五): 表示将来确定的安排
...
### 18.2.6 用法(六): 与always等连用，表示多次重复，且含有感情色彩
...
### 18.4.3 少见用法: 表示背景动作-提供另外一个短动作发生的事件背景

They probably will be watching TV when we get there.

### 18.4.4 难点用法1: 用在疑问句中，表示客气地询问
...
### 18.4.5 难点用法2: 用来表示客观的将来，以避免与表示'意愿'的will do混淆
...
## 18.5 难点: 深入分析进行时的思维特征
### 18.5.1 进行时态的核心含义(grammatical aspect)
...
### 18.5.2 进行时态与动词体(lexical aspect)
...
见 [高级教程 3 状语从句 3.3.6 since](#3.3.6-since)

## 19.10 过去完成时
### 19.10.1 在'过去'回顾'更远的过去'

过去完成时态是一个不能独立存在的时态，它必须依附于一个一般过去时态，也就是说，要先有一般过去时态，才可能有过去完成时态

### 19.10.2 延续事件-重复事件和单一事件的过去完成时

### 19.10.3 过去完成时的其他意义和用法
...
### 20.3.3 延续事件(二): 近期在延续的事件
### 20.3.4 延续事件(三): 在说话时刻仍在延续的事件
### 20.3.5 延续事件(四): 在说话时刻之前在延续的事件(即刚刚在延续的事件)
...
## 20.4 延续事件比较: 完成进行时与完成时
### 20.4.1 比较(一): 完成进行时'刚刚在延续的事件'与完成时'单一事件'
...
### 20.4.2 比较(二): 完成进行时的'延续'与完成时的'延续'
...
## 20.6 重复事件比较: 完成进行时与完成时
### 20.6.1 比较(三): 重复动作的分割性
...
### 20.6.2 比较(四): 短暂动词用于完成进行时来表示重复活动

### 20.6.3 完成进行时的'重复事件'与一般现在时的'重复事件'
...
## 20.7 完成进行时与完成时对比总结
### 20.7.1 比较(五): 完成进行时强调'延续过程'，完成时强调'成果'
