...
## 5.11 基本用法(六): 意愿willingness, 意图intention与执意insistence
...
### 10.9.2 不定式逻辑主语的构成(一): for + 名词或代词+ to do
...
### 10.9.3 不定式逻辑主语的构成(二): of sb. to do
...
## 10.10 不定式的时态和语态(一): 被动式(to be done)
...
## 10.11 不定式的时态和语态(二): 完成式(to have done)
...
## 10.12 不定式的时态和语态(三): 进行式(to be doing)
...
## 10.13 不定式的时态和语态(四): 完成进行式(to have been doing)
...
### 11.5.2 所有格还是普通格?
### 11.5.3 动名词复合结构的用法
## 11.6 动名词的时态和语态(一): 被动式(being done)
### 11.6.1 动名词的时态和语态概述
### 11.6.2 动名词的被动式
### 11.6.3 主动形式表示被动意思
## 11.7 动名词的时态和语态(二): 完成式(having done)
### 11.7.1 动名词的完成主动式
### 11.7.2 动名词的完成被动式
...
### 12.2.2 独立分词结构(一): "名词+分词"作状语
### 12.2.3 独立分词结构(二): "with+名词+分词"作状语
### 12.2.4 固定结构
### 12.2.5 分词作状语的意义
## 12.3 分词的作用(二): 定语
### 12.3.1 单个分词作定语要前置
...
## 14.3 现在虚拟(ZxCx)
## 14.4 过去虚拟(ZgCg)
## 14.5 混合虚拟(一): 主句现在+从句过去(ZxCg)
## 14.6 混合虚拟(二): 主句过去+从句现在(ZgCx)
## 14.7 倒装虚拟
...
3. 延续事件(二): 近期在延续的事件
4. 延续事件(三): 在说话时刻仍在延续的事件
5. 延续事件(四): 在说话时刻之前在延续的事件(即刚刚在延续的事件)
...
### 18.4.1 比较(一): 完成进行时'刚刚在延续的事件'与完成时'单一事件'
...
### 18.4.2 比较(二): 完成进行时的'延续'与完成时的'延续'
...
## 18.7 完成进行时与完成时对比总结
### 18.7.1 比较(五): 完成进行时强调'延续过程', 完成时强调'成果'
