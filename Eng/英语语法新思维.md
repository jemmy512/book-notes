...
#### 2.12.1 使用关系词what的前提: what的前面不能有先行词
...
#### 2.13.1 用when引导定语从句，其先行词必须是表示时间的名词
...
#### 2.13.2 先行词表示时间时，不一定都用when引导定语从句
...
#### 2.13.3 如何区分when引导的定语从句与when引导的时间状语从句
...
### 2.14 关系副词 where
#### 2.14.1 用where引导定语从句，其先行词通常是表示地点的名词
